...
Once hosted, add this pack with [cpackget](https://github.com/Open-CMSIS-Pack/cpackget):

```
cpackget add https://<vendor>.gitlab.io/<repo>/index.pidx
```

or point it directly at a released `.pack` file/URL.
